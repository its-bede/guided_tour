...
class ApplicationHelperTest < ActionView::TestCase
  ...
  def test_guide_through_generates_correct_markup
    ...
    assert_equal t('guided-tour.next-btn-text'), wrapper['data-guided-tour-next-btn-text-value']
    assert_equal t('guided-tour.prev-btn-text'), wrapper['data-guided-tour-prev-btn-text-value']
    assert_equal t('guided-tour.done-btn-text'), wrapper['data-guided-tour-done-btn-text-value']
    assert_equal t('guided-tour.step-line'), wrapper['data-guided-tour-step-line-text-value']

    # Test the overlay div
    overlay = doc.at_css('.guided-tour--overlay')
    assert overlay
    assert_equal 'overlay', overlay['data-guided-tour-target']
